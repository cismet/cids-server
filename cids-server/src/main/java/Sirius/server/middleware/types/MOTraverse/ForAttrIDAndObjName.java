...
/**
 * Sucht nach Attributen mit einem bestimmten ID in einem bestimmten MetaObject. Diese Klasse ermittelt ausschlieslich
 * die ObjectAttribute, MetaObject's werden nicht als ObjectAttribute erkannt sondern als ein beh\u00E4lter f\u00FCr
 * weitere ObjectAttributen.
 *
 * @author   awindholz
...
public class ForAttrIDAndObjName extends ForAttrAndObjName {
     ...
     */
    public ForAttrIDAndObjName(final String objectName, final String attrID) {
        super(objectName);
        this.attrID = attrID;
    }
