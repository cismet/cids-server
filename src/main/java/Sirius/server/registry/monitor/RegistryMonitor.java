...
public class RegistryMonitor extends JPanel implements Runnable
{
    ...
    private java.lang.Object[] columnnamesForServer=
    {"Name","IP","Port"};
    
    /** Die Tabellenueberschriften fuer die Anzeigetabelle User **/
    private java.lang.Object[] columnnamesForUser=
    {"ID", "Name", "local Servername", "Usergroup", "Admin"};
    ...
    /** Konstruktor
     * @param args[0] die IP-Adresse des CentralServers **/
    ...
    private void initMainPanel()
    {
        ...
        try
        {
            callServerTable 		 = new JTable(new MonitorTableModel(MonitorTableModel.convertToMatrix(callServer),columnnamesForServer));
            localServerTable 	 = new JTable(new MonitorTableModel(MonitorTableModel.convertToMatrix(localServer),columnnamesForServer));
            protocolServerTable = new JTable(new MonitorTableModel(MonitorTableModel.convertToMatrix(protocolServer),columnnamesForServer));
            // translServerTable	 = new JTable(new MonitorTableModel(MonitorTableModel.convertToMatrix(translServer),columnnamesForServer));
        ...
        {e.printStackTrace(); System.err.println("initmainPanel");}
