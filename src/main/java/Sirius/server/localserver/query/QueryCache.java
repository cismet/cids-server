...
//                logger.debug("searchOptions constructed :: "+new Vector(searchOptions.values()));
    ...
    private void setClassPermissions(String domain) {
        ...
        try {
            ...
            ResultSet rs = getQueryClassAssoc.executeQuery("SELECT * from cs_query_class_assoc");   // NOI18N
            ...
            while (rs.next()) {
                ...
                Object option = searchOptions.get(q_id + "@" + domain);   // NOI18N
    ...
    private void linkIt(String domain) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String qKey = from + "@" + domain;   // NOI18N
                ...
                } else // add QueryRumpf (referenziert anderen ls
                {
                    ...
                    Query father = (Query)queries.get(nameFrom + "@" + this.domain);   // NOI18N
    ...
    private void setSearchParameters(String domain) {
        try {
            ...
            while (rs.next()) {
                ...
                Query q = (Query)queries.get(queryKey + "@" + domain);   // NOI18N
    ...
    public int addQuery(
        ...
        String stmnt = "insert into cs_query values(" + maxId + ",'" + name + "','" + description + "','" + statement   // NOI18N
    ...
    public boolean addQueryParameter(
        ...
        String stmnt = "insert into cs_query_parameter values(" + maxId + "," + queryId + ",'" + paramKey + "','"   // NOI18N
