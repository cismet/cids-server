...
public class DefaultObject implements Object {
     ...
     */
    protected LinkedHashMap attribHash;    //**indicates whether a metaobject was instantiated from the database (already stored)*/
    /**
    ...
    public DefaultObject(Sirius.server.localserver.object.Object o) { // copy constructor
        ...
        if (o != null) {
            if (o.getAttributes() != null) {
                ...
                attribHash = new LinkedHashMap(10, 0.75f, false);            //  logger.debug("Kopierkonstruktor  attribute "+attribHash);
...
//
    ...
    public void addAttribute(ObjectAttribute anyAttribute)
        ...
        {
        attribs.add((Attribute)anyAttribute);
        }// end if AttributeOfClass
        else
        throw new java.lang.Exception(" no subtype of Attribute");
         */
        if (dummy) // in einem arrayLink Objekt m\u00FCssen alle Felder ausgef\u00FCllt sein egal was gesetzt wurde (Unsinnsbeschr\u00E4nkung)
        {
            anyAttribute.setOptional(false);
            if (logger != null) {
                logger.info("optional set to false for attribute : " + anyAttribute + " because it belongs to a arrayLink (dummy)");
            }
        }
    ...
    /**
     * Method from Hell
     * liefert ein Attribut ueber den Fieldname
    ...
    public Collection getAttributesByType(java.lang.Class c, int recursionDepth) {
        ...
        while (iter.hasNext()) {
            ...
            if (val != null && c.isAssignableFrom(val.getClass())) {
                ...
                attribsByType.addAll(((Sirius.server.localserver.object.Object) val).getAttributesByType(c, recursionDepth));
            }
        }
        return attribsByType;
...
//
     ...
     * @throws java.lang.Exception error during consturction of an DefaultObject
