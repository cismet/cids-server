 ...
 * einem XML-File dessen Inhalt anschliessend serialisiert wird. Der XML-File wird in Tempor\u00E4rem Verzeichnis des
 * Betriebssystem abgelegt. Der Name der Datei wird zusammen gesetzt aus praefix "jdbc" einer Ordnungszahl und suffix
 * ".xml". Die Ordnungszahl wird bestimmt durch die h\u00F6chste Ordnungszahl + 1 aus den Dateien die der oben
 * beschriebenen Signatur entsprechen und sich aktuell im Tempor\u00E4ren Verzeichnis befinden. Die Datei wird nach dem
 * sie serialisiert wurde standardm\u00E4sig gel\u00F6scht, dies kann verhindert werden in dem man. Die Objekte werden
 * \u00FCber getObject(..) Funktion aus dem Original-ResultSet in gecacheten unver\u00E4ndert \u00FCbernommen, wenn der
 * zuletzt eingelesene Wert SQL-NULL war(resultSet.wasNull() = true) so wird in XML-File ein String "SQL.NuLL" als Wert
 * geschrieben. Bildet ein Dataretrieval-Protokol. Bezeichnung dieses Protokols ist "jdbc_xml".
 *
 * @author   awindholz
...
public class JDBC_XMLProto extends JDBCProto {
    ...
    /**
     * Creates a new instance of JDBC_XMLProto Defaultm\u00E4sig wird die Datei nach dem sie serialisiert wurde
     * gel\u00F6scht.
     */
    ...
    /**
     * Konvertiert das \u00FCbergebene ResultSet zu einem XML-File und liefert dieses File serialisiert in einem
     * DataObjekt zur\u00FCck.
     *
     ...
     *
     * @return  Objekt vom typ DataObject das enth\u00E4lt das Serialisierte XML-Dokument mit ResultSet daten, sowie
    ...
    /**
     * Der XML-File wird in Tempor\u00E4rem Verzeichnis des Betriebssystem abgelegt. Der Name der Datei wird zusammen
     * gesetzt aus praefix "jdbc" einer Ordnungszahl und suffix .<erweiterung>. Die Ordnungszahl wird bestimmt durch die
     * h\u00F6chste Ordnungszahl + 1 aus den Dateien die der oben beschriebenen Signatur entsprechen und sich aktuell im
     * Tempor\u00E4ren Verzeichnis befinden. Die Dateien werden nach dem sie serialisiert wurden gel\u00F6scht.
     *
     * @param   filter       Filter der alle Dateien ausser mit \u00FCbergebener Erweiterung ausfilltert.
    ...
    /**
     * Schreibt Daten des \u00DCbergebenen ResultSet-Objektes in \u00FCbergebenen PrintWriter-Objekt. <RESULT><br>
     * <br>
     * <ROW><br>
     * <br>
     ...
     * <ROW><br>
     *
     * <p><FIELD name="Spaltenname 1">wert21</FIELD><br>
...
// logger.info("FERTIG");
    ...
    /**
     * Filtert alle Dateien aus die nicht die Signatur besitzen: Prefix "jdbc" postfix ".xml".
     *
     * @version  $Revision$, $Date$
     */
    class JdbcXmlFileFilter implements FilenameFilter {
        ...
        /**
         * Creates a new JdbcXmlFileFilter object.
         */
        JdbcXmlFileFilter() {
        }
