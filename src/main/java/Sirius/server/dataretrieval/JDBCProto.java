...
/**
 * Liest MetaDataObject, erstellt eine Verbindung zum Datenbank-Server und liefert
 * das zwischengespeicherte ResultSet-Objekt (als Byte-Array in einem DataObject)
 * zur\u00FCck. Bildet ein Dataretrieval-Protokol. * Bezeichnung dieses Protokols ist
 * "jdbc". Die Gr\u00F6sse des Caches wird aus der BackingStrore abgefragt, wenn dort
 * keine Daten vorhanden sind wird standardwert von 0,5 MB genommen. Das Backing
 * Store kann \u00FCber main dieser Klasse gesetzt werden.
 *
 * @author  awindholz
 */
public class JDBCProto implements MetaObjectProto {
    ...
    /**
     * Wenn keine Daten \u00FCber maximale gr\u00F6sse in der BackingStore gesetzt oder ein
     * fehler passiert wird die Gr\u00F6se auf 0,5 MB gesetzt.
     */
    public JDBCProto() {}
    ...
    /**
     * Speichert das \u00FCbergebene ResultSet zwischen und liefert dieses
     * in serialisierter Form in einem DataObjekt zur\u00FCck.
     *
     ...
     * ResultSet Objekt, sowie eine textuelle kurzbeschreibung in einem String.
     */
    protected DataObject createDataObject(ResultSet rs, String query, String name)
    throws DataRetrievalException, ResultSetTooLargeException {
        try {
...
/*    public boolean equals(Object o) {
     ...
     * im aktuell gesetztem MetaAttribut. Keine Rekursion.
     *
