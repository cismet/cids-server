 ...
 * Statement ab, holt das ResultSet konvertiert es zu einem CSV-File dessen
 * Inhalt anschliessend serialisiert wird. Der CSV-File wird in Tempor\u00E4rem
 * Verzeichnis des Betriebssystem abgelegt. Der Name der Datei wird zusammen
 * gesetzt aus praefix "jdbc" einer Ordnungszahl und suffix ".csv".
 ...
 * man. 
 * Bezeichnung dieses Protokols ist "jdbc_csv".
 * 
 *
 * @author  awindholz
 */
public class JDBC_CSVProto extends JDBC_XMLProto {
    ...
    /** Creates a new instance of JDBC_CSVProto 
    ...
    /**
     * Konvertiert das \u00FCbergebene ResultSet zu einem CSV-File und liefert dieses
     ...
     * CSV-Dokument mit ResultSet daten, sowie eine textuelle kurzbeschreibung 
     * in einem String.
     */
