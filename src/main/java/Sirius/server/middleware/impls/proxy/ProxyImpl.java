...
/** Benoetigte Keys fuer configFile:
 * registryIps <br>
 * serverName  <br>
 * jdbcDriver   **/
public class ProxyImpl extends UnicastRemoteObject
        implements CatalogueService, MetaService, RemoteObserver, SystemService,
        UserService, DataService, QueryStore, SearchService, TransactionService {
...
//    }
    public Node[] getChildren(Node node, User usr)
            throws RemoteException {
...
//    }
    public Node[] getRoots(User user, String localServerName)
            throws RemoteException {
...
//    {return catService.copySubTree(root,user);}
    ...
    public int insertMetaObject(User user, Query query, String domain)
            throws RemoteException {
        return metaService.insertMetaObject(user, query, domain);
    }

    public MetaObject insertMetaObject(User user, MetaObject metaObject, String domain)
            throws RemoteException {
        return metaService.insertMetaObject(user, metaObject, domain);
    }

    public int updateMetaObject(User user, MetaObject metaObject, String domain)
            throws RemoteException {
...
//    {
    ...
    public User getUser(
        ...
        return userService.getUser(
                userLsName, userName, userGroupLsName, userGroupName, password);
    }
    ...
    protected void register() throws Exception {
        nameServer.registerServer(ServerType.CALLSERVER, properties.getServerName(), InetAddress.getLocalHost().getHostAddress(), "1099");// localSERvername in callSERname
    ...
    public int addQuery(User user, String name, String description, String statement, int resultType, char isUpdate, char isBatch, char isRoot, char isUnion) throws RemoteException {
        return searchService.addQuery(user, name, description, statement, resultType, isUpdate, isBatch, isRoot, isUnion);
    }
    ...
    public boolean addQueryParameter(User user, int queryId, int typeId, String paramkey, String description, char isQueryResult, int queryPosition) throws RemoteException {
        return searchService.addQueryParameter(user, queryId, typeId, paramkey, description, isQueryResult, queryPosition);
    }
    ...
    public LightweightMetaObject[] getAllLightweightMetaObjectsForClass(int classId, User user, String[] representationFields, String representationPattern) throws RemoteException {
        return metaService.getAllLightweightMetaObjectsForClass(classId, user, representationFields, representationPattern);
    }
    ...
    public LightweightMetaObject[] getLightweightMetaObjectsByQuery(int classId, User user, String query, String[] representationFields, String representationPattern) throws RemoteException {
        return metaService.getLightweightMetaObjectsByQuery(classId, user, query, representationFields, representationPattern);
    }
