...
public class Query implements Mapable,java.io.Serializable {
   ...
   // protected java.lang.Class resultType;
    ...
    public QueryIdentifier getQueryIdentifier(){return qid;}
...
//  public String[] getPersistenceStatement(String sqlstatement)
//  {
//      String[] persistenceStatements = new String[parameters.size()+1];
//      
//      persistenceStatements[0] = "insert into cs_query values ("+qid.queryId+","+qid.name+","+qid.description+","+sqlstatement+","+resultType+","+isUpdate+","+isRoot+","+isUnionQuery+");\n";
//      
...
//            //is_query_result
//            boolean isQueryResult = ref.isQueryResult();
//            //query_position
//            int position = ref.getQueryPosition();
//        
//            
//     }
//      String paramterStmnt = "insert into cs_query_parameter values(?+","+);";
//     
//      
//      
//      return persistenceStatements;
//   
//  
//  }
//  
