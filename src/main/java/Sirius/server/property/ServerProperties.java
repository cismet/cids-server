...
/** Verwaltet Informationen zur allgemeinen Serverkonfiguration. (Local-, Call-, Translationserver).
 * Das jeweilige Configfile kann folgende Schluessel und Werte besitzen.
 * <table border=1>
 * <tr><td><b>KEY</b>							</td><td><b>VALUE</b></td><td><b>LS</b></td><td><b>CS</b></td><td><b>PS</b></td><td><b>TS</b></td><td><b>Registry</b></td></tr>
 * <tr><td>serverName							</td><td>Der Name, mit dem dieser Server im System in Erscheinung tritt</td><td>x</td><td>x</td><td>x</td><td>x</td><td></td></tr>
 * <tr><td>port      							</td><td>Der Port, mit dem dieser Server im System in Erscheinung tritt</td><td>x</td><td>x</td><td>x</td><td>x</td><td></td></tr>
 * <tr><td>defaultIconDirectory		</td><td>Standarddirectory fuer Icons</td><td>x</td><td></td><td></td><td></td></tr>
 * <tr><td>iconDirectory						</td><td>Directory fuer Icons</td><td>x</td></tr>
 * <tr><td>dbConnectionString			</td><td>der Connectionstring, um die Datenbank zu kontaktieren</td><td></td><td>x</td><td>x</td><td>x</td></tr>
 * <tr><td>translDbConnectionString</td><td>der Connectionstring, um die TranslationDB zu kontaktieren</td><td>x</td><td>x</td><td>x</td><td>x</td></tr>
 * <tr><td>jdbcDriver							</td><td>der JDBC-Treiber fuer die jeweilige DB</td><td>x</td><td>x</td><td>x</td><td> </td></tr>
 * <tr><td>dbType									</td><td>Art der DB</td><td>x</td><td>x</td><td>x</td><td>x</td></tr>
 * <tr><td>dbIP										</td><td>IP der Datenbank</td><td>x</td><td>x</td><td>x</td><td>x</td></tr>
 * <tr><td>dbPassword							</td><td>Benutzerpasswort fuer die DB</td><td>x</td><td>x</td><td>x</td><td>x</td></tr>
 * <tr><td>cacheStatements					</td><td>TRUE oder FALSE</td><td>x</td><td>x</td><td>x</td><td>x</td></tr>
 * <tr><td>fileSeparator						</td><td>"\\"fuer WinX-Systeme, "/" fuer Linux....</td><td>x</td><td>x</td><td>x</td><td>x</td></tr>
 * <tr><td>registryIPs							</td><td>die IP-Adressen, auf denen SiriusRegistries laufen und der Server sich anmelden soll. Mehrerer Adressen sind durch ; zu trennen</td><td>x</td><td>x</td><td>x</td><td></td></tr>
 * </table>
 * <br>
 * Beispielfile:<br><br>
...
public class ServerProperties extends java.util.PropertyResourceBundle
{
    ...
    /**
     * @return Pfad zu log4j-File des MetaJDBC-Treibers oder null wenn key
     * "log4j_prop_file" nicht vorhanden.
     */
    ...
    //----------------------------------------------------------------------------------------------------------------------------
    /** Liefert den Wert eines Keys als StringArray, sofern die einzelnen Tokens duch Semikolon getrennt sind.
     * z.b. a;b;c;def;gh
