...
public class ImageAnnotator
{
    ...
    public BufferedImage getAnnotatedImage()
    {
        ...
        if(watermark!=null)
        // wasserzeichen
        g.drawImage(watermark,newWidth-(watermark.getWidth()+5),newHeight-(watermark.getHeight()+5),null);
...
//    public void writeImage(BufferedImage im,Object output, String type) throws java.io.IOException
//    {
//    
...
//    }
    ...
    {
        String txt = "Freie Verwendung f\u00FCr den internen Dienstgebrauch, Publikation oder Weitergabe nur mit Einzelgenehmigung von R102 oder gem\u00E4\u00DF Rahmenvereinbarung mit R102";
        ...
        //String txt = "Freie Verwendung f\u00FCr den internen Dienstgebrauch. Publikation oder Weitergabe gem\u00E4\u00DF Rahmenvereinbarung mit R102 oder Einzelgenehmigung.";
