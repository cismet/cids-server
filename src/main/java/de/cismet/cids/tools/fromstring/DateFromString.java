...
//            {
            ...
            millis =  formater.parse(dateString).getTime();//Date.parse(dateString);
//            }catch(Exception e){e.printStackTrace();System.err.println("Date format falsch setzte date auf NOW");}
