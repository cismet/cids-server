...
public class CancelAsyncTaskAction extends DefaultServerAction {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(CancelAsyncTaskAction.class);

    public static final String TASK_NAME = "cancelAsyncTask";
    ...
    public Object execute(final Object body, final ServerActionParameter... saps) {
        if (getMetaService() instanceof ActionService) {
            ...
            if (uuid != null) {
                ...
                actionManager.deleteAction(uuid);
            }
        }
