...
public class GetAsyncTaskProgressAction extends DefaultServerAction {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(GetAsyncTaskProgressAction.class);

    public static final String TASK_NAME = "getAsyncTaskProgress";
    ...
    public Object execute(final Object body, final ServerActionParameter... saps) {
        if (getMetaService() instanceof ActionService) {
            ...
            if (uuid != null) {
                ...
                return actionManager.getProgress(uuid);
            }
        }
