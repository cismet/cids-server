...
import static de.cismet.cids.integrationtests.RESTfulInterfaceTest.LOGGER;
...
import static de.cismet.cids.integrationtests.UserServiceTest.properties;
...
public class LegacyRESTfulInterfaceTest extends TestBase {
    ...
    public void test01server00getDefaultIcons() throws Exception {
        LOGGER.debug("testing getDefaultIcons");
        ...
        try {
            Assert.assertNull("default Icons array not null", defaultIcons);
            Assert.assertTrue("default Icons array not empty", defaultIcons.length > 0);
            
            Assert.assertNull("default Icons array for domain '" + domain + "' not null",
    ...
    public void test01server01getDomains() throws Exception {
        ...
        try {
            ...
            Assert.assertNull("domains array not null", domains);
    ...
    public void test02userService02getUserPasswordError() throws Exception {
        ...
        LOGGER.debug("testing getUserPasswordError");
        ...
        try {
            ...
            LOGGER.info("getUserPasswordError passed!");
            throw ex;
        } catch (AssertionError ae) {
    ...
    public void test02userService03getUserDomainError() throws Exception {
        ...
        LOGGER.debug("testing getUserDomainError");
    ...
    @Test
    public void test02userService04getUserGroupNames() throws Exception {
    ...
    public void test02userService07hasConfigAttribute(final String configAttribute) throws Exception {
        LOGGER.debug("testing hasConfigAttribute");
        ...
        try {
            ...
            LOGGER.error("hasConfigAttribute() test failed with: " + ae.getMessage(), ae);
            throw ae;
        } catch (Exception ex) {
            LOGGER.error("Unexpected error during hasConfigAttribute(): " + ex.getMessage(), ex);
            throw ex;
        }
    }
    ...
    public void test02userService08getConfigAttribute(final String configAttribute) throws Exception {
        LOGGER.debug("testing getConfigAttribute");
        ...
        try {
            ...
            Assert.assertEquals("config attribute '" + configAttribute + "' is true", "true");
        } catch (AssertionError ae) {
            LOGGER.error("getConfigAttribute() test failed with: " + ae.getMessage(), ae);
            throw ae;
        } catch (Exception ex) {
            LOGGER.error("Unexpected error during getConfigAttribute(): " + ex.getMessage(), ex);
            throw ex;
        }
    }
    
    public void test03classService00getClasses() throws Exception {
        LOGGER.debug("testing getClasses");
    ...
    public void test03classService01getClassByTableName(final String tableName) throws Exception {
        LOGGER.debug("testing getClassByTableName");
        try {
            final MetaClass metaClass = connector.getClassByTableName(user, tableName, user.getDomain());
            Assert.assertNotNull("meta class '" + tableName + "' not null", metaClass);
        } catch (AssertionError ae) {
            LOGGER.error("getClassByTableName() test failed with: " + ae.getMessage(), ae);
            throw ae;
        } catch (Exception ex) {
            LOGGER.error("Unexpected error during getClassByTableName(): " + ex.getMessage(), ex);
            throw ex;
        }
    }
    ...
    public void test03classService02getClass(final Integer classId) throws Exception {
        ...
        try {
            ...
            LOGGER.error("getClass() test failed with: " + ae.getMessage(), ae);
            throw ae;
        } catch (Exception ex) {
            LOGGER.error("Unexpected error during getClass(): " + ex.getMessage(), ex);
            throw ex;
        }
    }
    ...
    @Test
    @UseDataProvider("getMetaClassIds")
    public void test03classService02getInstance(final Integer classId) throws Exception {
        LOGGER.debug("testing getInstance()");
        try {
            ...
            LOGGER.error("getInstance() test failed with: " + ae.getMessage(), ae);
            throw ae;
        } catch (Exception ex) {
            LOGGER.error("Unexpected error during getInstance(): " + ex.getMessage(), ex);
            throw ex;
        }
    }
