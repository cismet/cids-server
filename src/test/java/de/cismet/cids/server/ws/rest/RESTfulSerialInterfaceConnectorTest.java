...
public class RESTfulSerialInterfaceConnectorTest {
     ...
     */
    @Ignore
    // probably there is no dataobject for this metaobject, needs further investigation
    @Test
    public void testGetDataObject() throws Exception {
        ...
        final MetaObject metaObject = connector.getMetaObject(user, objectID, classID, domain);
    ...
    @Test
    @Ignore
    public void testGetDataObjectByQuery() throws Exception {
